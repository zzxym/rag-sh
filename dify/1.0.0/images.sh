...
echo 'dify 1.0.0 拉取镜像开始'

docker pull crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_api:1.0.0
docker pull crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_web:1.0.0
...
docker pull crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_plugin-daemon:0.0.3-local

echo 'dify 1.0.0 拉取镜像完成'

sleep 2

echo 'dify 1.0.0 镜像tag'

docker tag crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_api:1.0.0 langgenius/dify-api:1.0.0
docker tag crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_web:1.0.0 langgenius/dify-web:1.0.0
...
docker tag crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_plugin-daemon:0.0.3-local langgenius/dify-plugin-daemon:0.0.3-local

echo 'dify 1.0.0 镜像tag完成'