...
echo 'dify 1.2.0 拉取镜像开始'
docker pull crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_api:1.2.0
docker pull crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_web:1.2.0
...
docker pull crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_plugin-daemon:0.0.7-local
echo 'dify 1.2.0 拉取镜像完成'

sleep 2

echo 'dify 1.2.0 镜像tag'
docker tag crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_api:1.2.0 langgenius/dify-api:1.2.0
docker tag crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_web:1.2.0 langgenius/dify-web:1.2.0
...
docker tag crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_plugin-daemon:0.0.7-local langgenius/dify-plugin-daemon:0.0.7-local
echo 'dify 1.2.0 镜像tag完成'

sleep 2

echo 'dify 1.2.0 删除yunaiai镜像'
docker rmi crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_api:1.2.0
docker rmi crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_web:1.2.0
...
docker rmi crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_plugin-daemon:0.0.7-local
echo 'dify 1.2.0 删除yunaiai镜像完成'