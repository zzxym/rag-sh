...
echo 'dify 1.0.1 拉取镜像开始'
docker pull crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_api:1.0.1
docker pull crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_web:1.0.1
...
docker pull crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_plugin-daemon:0.0.4-local
echo 'dify 1.0.1 拉取镜像完成'

sleep 2

echo 'dify 1.0.1 镜像tag'
docker tag crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_api:1.0.1 langgenius/dify-api:1.0.1
docker tag crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_web:1.0.1 langgenius/dify-web:1.0.1
...
docker tag crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_plugin-daemon:0.0.4-local langgenius/dify-plugin-daemon:0.0.4-local
echo 'dify 1.0.1 镜像tag完成'

sleep 2

echo 'dify 1.0.1 删除yunaiai镜像'
docker rmi crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_api:1.0.1
docker rmi crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_web:1.0.1
...
docker rmi crpi-33mr80vehc50lqh8.cn-chengdu.personal.cr.aliyuncs.com/yunxinai/dify_plugin-daemon:0.0.4-local
echo 'dify 1.0.1 删除yunaiai镜像完成'