...
echo 'dify 1.0.1 开始安装'
sleep 1

mkdir -p /data/yunxinai/dify/1.0.1
cd /data/yunxinai/dify/1.0.1

echo 'dify 1.0.1 创建目录完成'
sleep 1

yum install -y git
echo 'dify 1.0.1 安装git完成'

cd /data/yunxinai/dify/1.0.1
git clone https://gitcode.com/yunxinai/rag-sh.git

echo 'dify 1.0.1 克隆git完成'

sh /data/yunxinai/dify/1.0.1/rag-sh/dify/1.0.1/images.sh
